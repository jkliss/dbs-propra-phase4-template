...
public class UnterkunftController {
    ...
    public Response list_unterkunft(@QueryParam("bezeichnung") String bezeichnung,@QueryParam("sterne") String sterne, @QueryParam("top") String top, List<String> names) throws SQLException {
        ...
        if (bezeichnung != null) stringStatement = stringStatement + " AND Bezeichnung=\""+ bezeichnung +"\" ";
